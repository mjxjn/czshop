 ...
 *
 * The followings are the available columns in table '{{goods_promotion}}':
 ...
 */
class GoodsPromotion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GoodsPromotion the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('gp_id, name, status, start_time, end_time, infos, op_type, brand_id, cid, min_price, bouns_id, add_time', 'safe', 'on'=>'search'),
		);
	}
